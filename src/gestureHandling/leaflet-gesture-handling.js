...
import { Map, DomEvent, Handler, DomUtil } from 'leaflet'

var draggingMap = false;

export var GestureHandling = Handler.extend({
    addHooks: function () {
        ...
        DomEvent.on(this._map, "mouseover", this._handleMouseOver, this);
        DomEvent.on(this._map, "mouseout", this._handleMouseOut, this);
    ...
    removeHooks: function () {
        ...
        DomEvent.off(this._map, "mouseover", this._handleMouseOver, this);
        DomEvent.off(this._map, "mouseout", this._handleMouseOut, this);
    ...
    _handleTouch: function (e) {
        ...
        for (var i = 0; i < ignoreList.length; i++) {
            if (DomUtihasClass(e.target, ignoreList[i])) {
                ignoreElement = true;
            }
        }
